...
module axi_interconnect #(
    ...
    output reg [(ADDRESS_BYTES * 8) - 1:0] m_axi_hp0_araddr,
    ...
    input wire [(DATA_BYTES * 8) - 1:0] m_axi_hp0_rdata,
    input wire m_axi_hp0_rlast,

    // Master write interface
    output reg m_axi_hp0_awvalid,
    input wire m_axi_hp0_awready,
    output reg [(ADDRESS_BYTES * 8) - 1:0] m_axi_hp0_awaddr,
    ...
    output reg [(DATA_BYTES * 8) - 1:0] m_axi_hp0_wdata,
